...
\todo[inline]{Abklären in der Gruppe ob nicht mehr Ergebnisse ins abstract müssen, klare Aussage, dass Fokus auf USABILITY liegt}
...
\todo[inline]{Klarere Formulierung: Mittelweg zwischen minimalen Mehraufwand und maximaler Sicherheit damit}
...
\todo[inline]{Offene Punkte: Probleme bei der Umsetzung beschreiben (Limitierende Faktoren), Bewertung des Konzept im Paper(z.B Dieses Verfahren macht alle geklauten Daten nutzlos, da nicht sicher ob sie korrekt sind), Ausarbeitung welche Teilkonzepte am erfolgversprechendsten sind, welche sind nicht machbar}
